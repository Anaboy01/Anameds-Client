...
import { getPatientFilesByDoctorId } from '../../redux/features/patientapi/patientSlice';
...
const CreatedPatientFile = () => {
      ...
      const handleSubmit = async (e) => {
        ...
        const actionResult = await dispatch(getPatientFilesByDoctorId(email));
    
         // Check if the action was successful before navigating
    if (getPatientFilesByDoctorId.fulfilled.match(actionResult)) {
      navigate('/CreatedFiles', { state: { data: actionResult.payload } });
...
export default CreatedPatientFile