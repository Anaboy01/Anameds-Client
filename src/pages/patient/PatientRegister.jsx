...
import { RESET, register } from '../../redux/features/patientapi/patientSlice';
...
// await dispatch(sendVerificationEmail());
  ...
  return (
    ...
    <form onSubmit={registerAPtient}  className=" bg-[#2c2f32] text-white p-4 rounded-lg w-[100%] shadow-md md:w-[100%] h-auto pb-4 text-center ">
