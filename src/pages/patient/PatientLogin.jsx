...
import { RESET, login, sendPatientLoginCode } from '../../redux/features/patientapi/patientSlice';
...
const PatientLogin = () => {
  ...
  const [formData, setFormData] = useState(initialState);
      ...
      const loginPatient = async (e) =>{
            ...
            await dispatch(login(patientData));
      ...
      useEffect(() => {
            ...
            if (isError && twoFactor){
                  ...
                  navigate(`/patientLoginCode/${email}`)
            }
  ...
  return (
    ...
    <div className=' bg-[#2c2f32] text-white p-4 rounded-lg w-[100%] shadow-md md:w-[50%] h-auto pb-4 text-center flex flex-col gap-3 items-center '>
        ...
        <form onSubmit={loginPatient} className='bg-[#2c2f32] text-white p-4 rounded-lg w-[100%] shadow-md md:w-[100%] h-auto pb-4 text-center '>
        ...
        <div className='w-[100%] flex items-left justify-between '>
                  ...
                  <Link to='/patientForgotenPassword'>
